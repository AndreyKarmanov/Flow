...
urlpatterns = [
    ...
    path("schools/<int:school_id>/departments/<int:department_id>/courses/", views.InfiniteScroll.as_view(), name="department"),
    ...
    path("infinite/", views.InfiniteScroll.as_view(), name="infinitescroll"),
]