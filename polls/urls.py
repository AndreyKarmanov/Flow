...
urlpatterns = [
    ...
    path("schools/<int:school_id>/departments/", views.InfiniteDepartments.as_view(), name="school"),
    path("schools/<int:school_id>/departments/<int:department_id>/courses/", views.InfiniteCourses.as_view(), name="department"),
